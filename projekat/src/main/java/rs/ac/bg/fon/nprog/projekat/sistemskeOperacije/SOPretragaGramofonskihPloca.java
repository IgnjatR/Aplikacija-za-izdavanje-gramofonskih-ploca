 ...
 * @author Ignjat
 */
public class SOPretragaGramofonskihPloca {

    public SOPretragaGramofonskihPloca() {
    }
    
    
    public ServerskiOdgovor nadjiPlocu(KlijentskiZahtev kz) {
        ...
        ;
        so.setOdgovor(rsb.pronadjiPlocu(ploca.getNaziv(),ploca.getAutor()));
