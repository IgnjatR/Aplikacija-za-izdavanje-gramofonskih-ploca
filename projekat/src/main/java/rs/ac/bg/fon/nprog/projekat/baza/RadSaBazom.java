...
public class RadSaBazom {
    ...
    public boolean dodajPlocu(Ploca ploca) {
        ...
        String upit = "insert into ploca(autor,brojPesama,cenaIzdavanja,datumIzdavanja,naziv) values('" + ploca.getAutor() + "','" + ploca.getBrojPesama() + "','" + ploca.getCenaIzdavanja() + "','" + datum + "','" + ploca.getNaziv() + "')";
        System.out.println(upit);
    ...
    public boolean izmeniPlocu(Ploca ploca) {
        ...
        String upit = "UPDATE ploca SET autor = '" + ploca.getAutor() + "',naziv='" + ploca.getNaziv() + "',cenaIzdavanja='" + ploca.getCenaIzdavanja().toString() + "',brojPesama='" + String.valueOf(ploca.getBrojPesama()) + "',datumIzdavanja='" + datum + "' WHERE idPloce =" + String.valueOf(ploca.getIdPloce());
        System.out.println(upit);
        Statement st;
...
//        }
        ...
        String upit = "insert into zaduzenje(idKlijenta,idZaposlenog,datum,ukupno)  values('" + zaduzenje.getKlijent().getIdKlijenta() + "','" + zaduzenje.getZaposleni().getIdZaposlenog() + "','" + datum + "','0')";
        System.out.println(upit);
...
//        }
        ...
        String upit = "insert into stavkazaduzenja(idZaposlenog,idKlijenta,idZaduzenja,kolicina,vrednost,idPloce) values('" + stavka.getZaposleni().getIdZaposlenog() + "','" + stavka.getKlijent().getIdKlijenta() + "','" + Kontroler.getInstance().getIdPoslednjegUnetogZaduzenja() + "','" + stavka.getKolicina() + "','" + stavka.getVrednost().toString() + "','" + stavka.getPloca().getIdPloce() + "')";
        System.out.println(upit);
    ...
    private void osveziZaduzenje(BigDecimal vrednost, int IDZaduzenja) {
        ...
        String upit = "UPDATE zaduzenje SET ukupno = ukupno + '" + vrednost.toString() + "' WHERE sifraZaduzenja =" + String.valueOf(IDZaduzenja);
        System.out.println(upit);
        Statement st;
    ...
    public boolean izmeniZaduzenja(ArrayList<Zaduzenje> zaduzenja) {
        ...
        for (Zaduzenje zaduzenje : zaduzenja) {
            ...
            String upit = "UPDATE zaduzenje SET datum = '" + datum + "',ukupno='" + zaduzenje.getUkupno().toString() + "',idKlijenta='" + zaduzenje.getKlijent().getIdKlijenta() + "',idZaposlenog='" + zaduzenje.getZaposleni().getIdZaposlenog() + "' WHERE sifraZaduzenja =" + String.valueOf(zaduzenje.getSifraZaduzenja());
            System.out.println(upit);
            Statement st;
